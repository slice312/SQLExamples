CREATE DATABASE dudes DEFAULT CHARACTER SET utf8;
-- DROP DATABASE dudes;
-- DROP TABLE person;
...
(
  ...
  CONSTRAINT FK_favorite_food__person FOREIGN KEY (person_id)
...
ALTER TABLE favorite_food DROP FOREIGN KEY FK_favorite_food__person;
ALTER TABLE person MODIFY person_id SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT;

ALTER TABLE favorite_food
  ADD CONSTRAINT FK_favorite_food__person FOREIGN KEY (person_id)
    REFERENCES person (person_id);
